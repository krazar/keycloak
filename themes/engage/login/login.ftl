        ...
        <#if realm.password && social.providers??>
            ...
            <div id="kc-social-providers" class="wrapper__login__sso ${properties.kcFormSocialAccountSectionClass!}">
                ...
                <div class="wrapper__login__sso__button">
                    ...
                    <div class="WFEMLUB" style="left: 1029px; top: 307px; z-index: 2; position: absolute; overflow: visible; outline-style: none; display: block;" data-wfx-attr="true" aria-hidden="true" id="wfx-smartinfo">
                        <div class="">
                            <div class="gwt-HTML">
