...
<head>
    ...
    <script type="application/javascript">
        ...
        customCss.href = "https://" + window.location.hostname +
            "/library/qualifio_showcases/emails/keycloak-themes/internal/css/" + (window.location.hostname).replaceAll('.', '_') +
            ".css";

        //local examples
        //customCss.href = "http://localhost/auth/resources/bj1p1/login/generic-theme/css/brusseleers-example.css";
        //customCss.href = "http://localhost/auth/resources/bj1p1/login/generic-theme/css/christmas-example.css";
        ...
        customCss.onload = () => {
            setTimeout(showMainDiv, 100);
        };
        customCss.onerror = showMainDiv;
...
<div id="main" class="${properties.kcLoginClass!} hidden">
